...
export class Question {
     ...
     *                       - answerKey: The answer key to the question (string).
     ...
     */
    #fillData(data) {
        // Check if the data is an array and has at least 3 elements (name, studentAnswer, answerKey).
        ...
        /**
         * @type {string} - The answer key to the question (converted to uppercase).
         */
        this.answerKey = data[2].toUpperCase();
        /**
         ...
         *                         - true: if the student's answer matches the answer key or if the answer key is "_".
         *                         - null: if the student's answer is "_".
         *                         - false: otherwise.
         */
        this.status;
        if (this.studentAnswer === this.answerKey || this.answerKey === "_") {
            this.status = true;
     ...
     * @param {Array} data - An array containing the new question data: [name, studentAnswer, answerKey, difficulty].
     */
    update(data) {
        this.#fillData(data);
    }
